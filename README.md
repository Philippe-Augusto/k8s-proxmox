...
Primeiro, atualize os pacotes do SO e instale os pacotes necessários para usar o repositório apt do Kubernetes:
    sudo apt-get update
...
Teste o kubectl com o comando: 

kubectl cluster-info

Caso voce obtenha uma resposta semelhante a essa:
The connection to the server <server-name:port> was refused - did you specify the right host or port?
Significa que o kubectl foi instalado com sucesso


Ative o bash completation do kubectl (Isso vai te ajudar muito durante o deploy do kubernetes e das aplicações):
...
MUITO IMPORTANTE:
Habilite o net.ipv4.ip_forward, para isso execute:
sudo nano /etc/sysctl.conf e descomente a linha:
